...
void DMA0_setup(void) {
    ...
    DMA_IER = 0x00F0; /* Enable interrupts for DMA0CH0-DMA0CH3 */
    
	/* Step 5 - Setup sync event */
	register_value = DMA1_CESR1;
	DMA1_CESR1 = register_value | 0x0101; /* Set CH1, CH0 sync event to I2S0 transmit */
	register_value = DMA1_CESR2;
	DMA1_CESR2 = register_value | 0x0202; /* Set CH3, CH2 sync event to I2S0 receive*/

	/* Step 6 - Channel source addresses */
	DMA1_CH2_SSAL = 0x2A28;//I2S0_RXLT0; /* 16 LSBs of I2S0 left receive */
	DMA1_CH2_SSAU = 0x0000;
	
	DMA1_CH3_SSAL = 0x2A2C;//I2S0_RXRT0; /* 16 LSBs of I2S0 right receive */
	...
	DMA1_CH0_DSAL = 0x2A08;//I2S0_TXLT0;
	DMA1_CH0_DSAU = 0x0000;
	
	DMA1_CH1_DSAL = 0x2A0C;//I2S0_TXRT0;
...
#else
    DMA1_CH2_TCR2 = 0x3080;
    DMA1_CH3_TCR2 = 0x3080;
    DMA1_CH0_TCR2 = 0x3200;
    DMA1_CH1_TCR2 = 0x3200;
#endif
}
